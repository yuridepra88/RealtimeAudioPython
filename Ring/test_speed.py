########
#
# Test the performance of the 4 implentations: interpreted approach, cython annotation, cython with C bindings, numba
#
###############
...
for i in range (0,1000): # iterate over the chunks
	...
	#l.run('compute(sample, mod_sample)')     #this computation slows down the overall evaluation (exeeds many time real-time)
	
	l.run('compute_numba(sample, mod_sample)')
	l.run('compute_cython(sample, mod_sample)')
