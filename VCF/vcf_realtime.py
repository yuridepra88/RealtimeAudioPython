################
#
# Real-time implementations of the VCS3: cython annotation, cython with C bindings, numba
#
########################
import pyaudio
import numpy as np
...
while len(data) == (FRAMES_PER_BUFFER*2):
	...
	#y = compute_cython(sample)
	y = compute_cython_c(sample)
	#y = compute_numba(sample)
